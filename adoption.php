...
<head>
    ...
    <head>
        ...
        <title>Adoption- <?php echo $row['first_name']; ?></title>
    ...
    <h1>Adoption</h1><br>
        <form method="POST">
            <img src="picture/<?php echo $rowp['picture']; ?>" class="img-thumbnail w-50">
                <h5 class="card-title"><?php echo 'Name : ' .  $rowp['name']; ?></h5>
                <p class="card-text"><?php echo '<p class = "fw-bold">Description:</p>' .  $rowp['dis']; ?></p>
                <p class="card-text"><?php echo '<p class = "fw-bold">Size:</p>' .  $rowp['size']; ?></p>
                <p class="card-text"><?php echo '<p class = "fw-bold">Age:</p>' .  $rowp['age']; ?></p>
